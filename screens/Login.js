...
export default function Login({ navigation }) {
    ...
    const [passwordInput, setPasswordInput] = useState('1mmU9pMD'); // Estado para guardar el valor del input de contraseña
    const [legajoInput, setLegajoInput] = useState('10010'); // Estado para guardar el valor del input de legajo
