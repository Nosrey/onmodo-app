...
export default function FormType2({ setVisibleForm, visibleForm, reglones, setReglones, setViewDelete, setReglonPicked, editionMode, setEditionMode, setViewInfo}) {
    ...
    return (
        <View style={styles.container}>
            ...
            <DatePicker inputReceived={cardToCheck.inputs[0]} index={0} setInputsGlobal={setInputsGlobal} />
            ...
            <DatePicker inputReceived={cardToCheck.inputs[3]} index={3} setInputsGlobal={setInputsGlobal} />

            <TimePicker inputReceived={cardToCheck.inputs[4]} index={4} setInputsGlobal={setInputsGlobal} />
